...
def greetings():
  ...
  for x in range(0, len(names)+1):
    print(f" Hello {names[x]}. How has your day been going?")
...
def favorite_music():
  ...
  sentances = [
      ...
      "name has had at least one good song",
      "name makes good music",
      "i think name is a pretty cool person",
      "have you heard of name? they make music",
      "name is the best artist",
      "name makes some good music sometimes",
      "name has an amazing voice",
      "I love the music that name makes",
      "name makes music sometimes"
    ]
  usedSentances = []
...
def autoMenu():
  ...
  if menuMode == 2:
    ...
    import independentPractice14 as foo
    list = []
