# Zachary hoover || Independent Practice 6
# 10-6-22
import os
import random
...
# checks if user input is a multible of 10
def multiplesOfTen():
	printHeader()
	...
	if usrin % 10 != 0:
		print(f" the number {usrin} is not a multiple of 10 ")
	else:
		print(f" the number {usrin} is a multiple of 10")
...
def randomNumberGuesser():
	...
	usrin = int(input(" please enter a number between 1 - 10: "))
	...
	if randnum == usrin:
		...
		print(f" the computer guessed incorrectly, the computer guessed {randnum}")
	returnMain()
...
def autoMenu():	
	...
	if benchMode != True:
		...
		import independentPractice6 as foo
